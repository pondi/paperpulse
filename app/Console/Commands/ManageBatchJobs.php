    ...
    protected function listBatches(): int
    {
        ...
        $tableData = $batches->map(function ($batch) {
            return [
                ...
                number_format($batch->progress_percentage, 1).'%',
                '$'.number_format($batch->actual_cost, 2),
    ...
    protected function showStatus(): int
    {
        ...
        try {
            ...
            $this->table(['Field', 'Value'], [
                ...
                ['Estimated Cost', '$'.number_format($status['estimated_cost'], 4)],
                ['Actual Cost', '$'.number_format($status['actual_cost'], 4)],
