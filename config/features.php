...
return [
    ...
    */
    ...
    'beta' => [
        ...
        'enabled' => env('ENABLE_BETA_FEATURES', in_array(env('APP_ENV'), ['local', 'development'])),

        // Individual feature flags
        'documents' => env('BETA_DOCUMENTS', env('ENABLE_BETA_FEATURES', in_array(env('APP_ENV'), ['local', 'development']))),
    ],
];
