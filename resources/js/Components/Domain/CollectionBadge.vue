<template>
    <span
        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium cursor-pointer transition-opacity hover:opacity-80"
    ...
    >
        ...
        <button
            v-if="removable"
            @click.stop="$emit('remove', collection.id)"
