<template>
  <div class="relative h-full w-full">
    <!-- Image display (use previewUrl if available, otherwise try url) -->
...
const props = defineProps({
  ...
  errorMessage: {
    type: String,
    default: 'Failed to load document image'
  },
  noImageMessage: {
    type: String,
    default: 'No document preview available'
  },
  showPdfButton: {
    type: Boolean,
    default: true
...
// Use previewUrl if available (for converted docs), otherwise fall back to url
