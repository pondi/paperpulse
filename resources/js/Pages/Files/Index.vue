    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="mb-8">
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">File Management</h1>
                ...
                <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                    <div class="rounded-lg bg-white p-4 shadow dark:bg-gray-800">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 rounded-md bg-blue-100 p-3 dark:bg-blue-900/40">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ props.files.data.length }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg bg-white p-4 shadow dark:bg-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ failedCount }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Files List -->
                <div v-if="props.files.data.length === 0" class="rounded-lg bg-white p-12 text-center shadow dark:bg-gray-800">
                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-gray-100">No files yet</h3>
                        ...
                        <div class="p-6">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <a
                                                ...
                                                target="_blank"
                                                class="text-lg font-semibold text-gray-900 hover:text-indigo-600 dark:text-gray-100 dark:hover:text-indigo-400 truncate block"
                                                :title="file.name"
                                            >
                                                {{ file.name }}
                                            </a>
                            ...
                            <div class="mt-4 flex items-center gap-3">
                                <a
                                    :href="file.viewUrl"
                                    target="_blank"
                                    class="inline-flex items-center gap-1.5 rounded-md bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-200 dark:ring-gray-600 dark:hover:bg-gray-600"
                                >
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            >
                                <h4 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Change Processing Type</h4>
                                    ...
                                    <div class="flex gap-4">
                                        <label class="flex items-center">
                                            <input
                                                ...
                                                type="radio"
                                                value="receipt"
                                                class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600 dark:border-gray-600 dark:bg-gray-700"
                                            />
                                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Receipt</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input
                                                v-model="selectedTypeById[file.id]"
                                                ...
                                                class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600 dark:border-gray-600 dark:bg-gray-700"
                                            />
                                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Document</span>
                                        </label>
                                    </div>
