  ...
  <div class="bg-gray-800 shadow-sm rounded-lg p-6 mb-6 border border-gray-700">
    <div class="flex gap-4">
      <select 
        ...
        class="bg-gray-700 text-white rounded-md border-gray-600 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
      >
      ...
      <input 
        ...
        class="bg-gray-700 text-white rounded-md border-gray-600 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 placeholder-gray-400"
      >
    </div>
  </div>
</template>
