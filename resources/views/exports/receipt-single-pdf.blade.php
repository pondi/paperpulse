...
<div class="info-section">
    <div class="info-row">
        ...
        <div class="info-value">
            {{ $receipt->receipt_date ? Carbon::parse($receipt->receipt_date)->format('F d, Y') : 'N/A' }}
        </div>
    </div>
    <div class="info-row">
    ...
    <div class="info-row">
        <div class="info-label">Document Note:</div>
        <div class="info-value">{{ $receipt->note ?: 'No note' }}</div>
    </div>
    <div class="info-row">
